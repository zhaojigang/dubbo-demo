...
public class TestBasic {
    public static void main(String[] args) {
        ...
        loadedExtensions.forEach(System.out::println);

        System.out.println("======================= 根据 SPI 实现类实例或者 Class 信息获取其 key =======================");
        // 5. 根据实例或者
        System.out.println(loader.getExtensionName(logback));
        System.out.println(loader.getExtensionName(Logback.class));
